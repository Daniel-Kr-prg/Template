...
{
    public enum WorldInteraction_Camera_PivotConstraintMode
    {
        MoveInside,
        MoveOutside
    }
    ...
    [ExecuteAlways]
    public sealed class WorldInteraction_Camera_PivotConstraintVolume : MonoBehaviour
    {
        [SerializeField] private WorldInteraction_Camera_PivotConstraintMode mode = WorldInteraction_Camera_PivotConstraintMode.MoveInside;
        ...
        public WorldInteraction_Camera_PivotConstraintMode Mode => mode;
        ...
        public Vector3 Apply(Vector3 worldPosition, float radius, bool immediate)
        {
            ...
            if (mode == WorldInteraction_Camera_PivotConstraintMode.MoveInside)
            {
        ...
        private void OnDrawGizmos()
        {
            ...
            if (softDistance > 0f)
            {
                var offset = mode == WorldInteraction_Camera_PivotConstraintMode.MoveInside ? -softDistance : softDistance;
