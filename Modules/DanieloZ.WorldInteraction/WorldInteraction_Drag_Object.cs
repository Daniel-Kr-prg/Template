...
{
    public class WorldInteraction_Drag_Object : MonoBehaviour
    {
        #region Inspector
        ...
        [OdinHideLabel]
        [SerializeField] private WorldInteraction_Drag_ConstraintSettings constraints = new();
        ...
        public event Action<WorldInteraction_Drag_Object> PickedUp;
        public event Action<WorldInteraction_Drag_Object> Released;
        public event Action<WorldInteraction_Drag_Object> ReturnedToPhysics;
        ...
        public WorldInteraction_Drag_ConstraintSettings Constraints => constraints;
        ...
        private readonly WorldInteraction_Drag_HeldPoseState poseState = new();
        private readonly WorldInteraction_Drag_HeldRotationState rotationState = new();
        private readonly WorldInteraction_Drag_WobbleState wobbleState = new();
        private readonly WorldInteraction_Drag_ReleaseInertiaState inertiaState = new();
        ...
        protected virtual void OnDisable()
        {
            ...
            WorldInteraction_Runtime_InputGate.ReleaseHeldObject(this);
        }
        ...
        public virtual void BeginDrag()
        {
            ...
            if (!WorldInteraction_Runtime_InputGate.TryClaimHeldObject(this))
            {
                return;
            }
        ...
        {
            return WorldInteraction_Drag_HeldRotationState.SnapYawToGrid(yaw, 0f, yawStep);
        }

        protected static float SnapYawToGrid(float yaw, float gridBaseYaw, float step)
        {
            return WorldInteraction_Drag_HeldRotationState.SnapYawToGrid(yaw, gridBaseYaw, step);
        }
