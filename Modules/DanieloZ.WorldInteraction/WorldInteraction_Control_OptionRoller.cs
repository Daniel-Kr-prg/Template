...
namespace DanieloZ.WorldInteraction
{
    ...
    public sealed class WorldInteraction_Control_OptionRoller : MonoBehaviour, IWorldInteraction_Pointer_Draggable
    {
        #region Types
        ...
        public event Action<WorldInteraction_Control_OptionRoller, int> IndexChanged;
        ...
        private Material GetSelectedPreviewMaterial()
        {
            ...
            {
                name = "WorldInteraction_Control_OptionRoller Selected Preview (Generated)",
        ...
        private static Mesh GetSelectedPreviewMesh()
        {
            ...
            {
                name = "WorldInteraction_Control_OptionRoller Selected Preview Quad"
            };
        ...
        private void RestoreCursor(bool moveToRollerCenter)
        {
            ...
            {
                WorldInteraction_Pointer_CursorUtility.Restore(cursorState, dragCamera, RollerTransform.position);
            }
            else
            {
